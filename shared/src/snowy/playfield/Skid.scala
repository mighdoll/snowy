...
object Skid {
  ...
  /** Return a rotated speed vector adjusted for skidding effect for a sled. Quickly
    * moving sleds continue in the same direction (as if they had momentum), slower sleds
    * change direction more swiftly.
    */
  def skid(
        current: Vec2d,
        rotation: Double,
