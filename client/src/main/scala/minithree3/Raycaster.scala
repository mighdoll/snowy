...
@js.native
@js.annotation.JSGlobal("Raycaster")
class Raycaster protected () extends js.Object {
  ...
  /**
     ...
     */
  def intersectObject(`object`: Object3D, recursive: Boolean = js.native, optionalTarget: js.Array[Intersection] = js.native): js.Array[Intersection] = js.native
  /**
     ...
     * @param optionalTarget (optional) target to set the result. Otherwise a new Array is instantiated. If set, you must clear this array prior to each call (i.e., array.length = 0;). 
     */
  def intersectObjects(objects: js.Array[Object3D], recursive: Boolean = js.native, optionalTarget: js.Array[Intersection] = js.native): js.Array[Intersection] = js.native
}