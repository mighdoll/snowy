...
@js.native
@js.annotation.JSGlobal("Geometry")
class Geometry extends EventDispatcher {
  ...
  def merge(geometry: Geometry, matrix: Matrix = js.native, materialIndexOffset: Double = js.native): Unit = js.native
  ...
  def setFromPoints(points: js.Array[Vector2] | js.Array[Vector3]): Geometry = js.native
